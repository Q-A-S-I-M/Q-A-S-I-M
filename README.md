...
🎓 &nbsp;Currently in my third year (Class of 2027) with a GPA of 3.44/4.0.  
...
- **Keystroke Dynamics**  
  Python + Firebase | Collected typing patterns to build models for user authentication using ML techniques.
  
- **SwapSphere**  
  Spring Boot + MySQL + React | Community bartering platform with JWT authentication, real-time chat, and item swapping.
...
- **Ice Cream Factory**  
  C + POSIX IPC | Simulated multi-step factory with multithreading, semaphores, and mutexes for order processing.
